...
const ADDON_CATALOG = [
  ...
  },
  {
    ...
    setupRequired: false,
    activationMethod: 'IMMEDIATE_UPON_PAYMENT',
  ...
  },
  {
    ...
    entitlementKeys: ['accountant_reports'],
    setupRequired: false,
    activationMethod: 'ADMIN_APPROVAL',
    expiryPolicy: 'DISABLE_FEATURE_PRESERVE_DATA'
  }
...
class AddonService {
  ...
  static getAddonById(addonId) {
    return ADDON_CATALOG.find(a => a.id === addonId) || null;
  }
  ...
  static async isAddonActive(organizationId, addonId) {
    ...
    try {
      ...
      if (payload.expiresAt && Date.now() > payload.expiresAt) {
        // Automatically transition to EXPIRED without deleting user data
